import { Keyboard, KeyCallback, KeyEffectMode, KeymapMode } from "./keyboard";
...
export class Input {
  ...
  public static map(mappings, callback?: InputCallback, effectMode: InputEffectMode = 'interval', keymapMode: KeymapMode = 'add'): KeyboardMapping {
